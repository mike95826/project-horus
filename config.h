...
//
// However we should be using the Experimental APRS destination
// field until trackuino is registered with the APRS SIG
//
#define D_CALLSIGN      "APZ001"
...
#define APRS_COMMENT    "http://projecthorus.org/"
