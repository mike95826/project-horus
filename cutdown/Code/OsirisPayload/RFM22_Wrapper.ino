...
RF22::ModemConfig OOK_500bd=  { 0x2b, 0x03, 0xd0, 0xe0, 0x10, 0x62,0x00, 0x05, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x04, 0x19, 0x2c, 0x23,
0x01 };// these values correspond to 500bps tx rate no manchestger OOK - and are the lowest values that are
...
void RFM22B_RX_Mode(){
	...
	rf22.setModemRegisters(&OOK_500bd);
	rf22.setModeRx(); 
